...
public class Speech {
	...
	private static final String SECRET = "f53587857d374e1ab8f178d58efe970f";
    // Clova Speech invoke URL
	private static final String INVOKE_URL = "https://clovaspeech-gw.ncloud.com/external/v1/6417/3ccbfac438af58a6d7b77812d73e9623ac780669348caf76a1892a7a4c0e5e8d";
	...
	public String speechTest(String path) {
		...
		final String result =
			clovaSpeechClient.upload(new File(path+"\\audio1.mp3"), requestEntity);
